...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // 350ms - 550ms: Heading lines staggered upward through masked overflow container
      .fromTo(
        ".heading-line",
        { y: "100%", opacity: 0 },
      ...
      // 400ms overlap: Bottle entrance (slow fade + scale 0.9 -> 1 + unrotate)
      .fromTo(
        ".hero-bottle",
      ...
      // Concentric circles pulse & expand
      .fromTo(
        ".hero-circle",
        { scale: 0.6, opacity: 0 },
      ...
      // Badge appears after bottle settles
      .fromTo(
        ".hero-badge",
        { y: 15, opacity: 0 },
        { y: 0, opacity: 1, duration: 0.8 },
      ...
      // Continuous subtle idle floating animation for the bottle
      ...
      // ScrollTrigger: Subtle bottle rotation and parallax drift on scroll
  ...
  return (
    <main ref={heroRef} className="hero-section relative min-h-screen bg-[#F8F5F1] text-[#171615] overflow-hidden pt-32 lg:pt-36 pb-20">
      <Navbar />
      ...
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center min-h-[calc(100vh-10rem)]">
        ...
        {/* Left Column: Typography & Campaign Copy */}
        <div className="lg:col-span-7 flex flex-col justify-center space-y-6 z-10 pt-12 lg:pt-0">
          ...
          {/* Masked Heading Container for Line-by-Line Reveal */}
        ...
        {/* Right Column: Editorial Product Anchor */}
        <div className="hero-bottle-container lg:col-span-5 relative h-[500px] lg:h-[650px] flex items-center justify-center mt-8 lg:mt-0">
          ...
          {/* Subtle Peach/Rose Ambient Glow */}
          ...
          {/* Faint Concentric Circle Watermark */}
          ...
          <div className="hero-bottle-float relative w-full h-[420px] lg:h-[540px] flex items-center justify-center z-10">
            {/* Main Product Image */}
            <div className="hero-bottle relative w-full h-full flex items-center justify-center opacity-0">
              <Image 
